    ...
    <div className="min-h-screen bg-black relative overflow-hidden">
      ...
      <div className="w-full h-screen bg-gradient-to-br from-gray-900 to-black flex items-center justify-center">
        <div className="text-center">
          <div className="text-lagado-green text-3xl mb-4">⚡</div>
          <p className="text-body text-lagado-text">Agent executing...</p>
          <p className="text-caption text-lagado-text-dim mt-2 font-mono">
      ...
      <div className="absolute bottom-6 left-1/2 transform -translate-x-1/2 w-full max-w-xl px-4">
        <div
          className="bg-lagado-glass-trans backdrop-blur-xl border border-lagado-border-light rounded-sm p-4 shadow-2xl"
          style={{ backdropFilter: "blur(24px) saturate(120%)" }}
        >
          <div className="flex items-center justify-between gap-3">
            <div className="flex items-center gap-3 flex-1">
              <span className="text-xl animate-pulse">⏳</span>
              <span className="text-body text-lagado-text">Executing: click...</span>
            </div>
