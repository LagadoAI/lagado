      ...
      <div className="flex-1 flex">
        ...
        <div className="w-64 border-r border-laputa-border bg-laputa-surface p-4">
          ...
          <div className="space-y-1 text-body-sm">
            <div className="px-2 py-1 hover:bg-laputa-surface-2 rounded cursor-pointer">📁 Docs/</div>
            <div className="px-2 py-1 bg-laputa-surface-2 rounded cursor-pointer text-laputa-text-bright">
              📄 project_brief.md
            </div>
          </div>
        </div>
        ...
        <div className="flex-1 flex flex-col">
          <div className="flex-1 p-6 overflow-y-auto">
            <div className="max-w-3xl mx-auto">
              <h1 className="text-h1 text-laputa-text-bright font-bold mb-4">
                Project Brief
              </h1>
              ...
              <h2 className="text-h2 text-laputa-text-bright font-bold mb-3 mt-6">
                Section 1
              </h2>
              <p className="text-body text-laputa-text mb-3">
                Content here...
              </p>
            </div>
          </div>
          ...
          {/* Footer with actions */}
          <div className="p-4 border-t border-laputa-border bg-laputa-surface flex items-center justify-between">
            <MetadataList
              items={[
