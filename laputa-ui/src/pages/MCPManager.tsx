    ...
    <div className="min-h-screen bg-laputa-bg flex flex-col">
      ...
      <div className="flex-1 p-6 max-w-5xl mx-auto w-full">
        <div className="flex justify-between items-center mb-6">
          <div>
            <h1 className="text-h1 text-laputa-text-bright font-bold">MCP Manager</h1>
            <p className="text-body text-laputa-text-dim mt-1">
              Connected Tools (12)
            </p>
          </div>
            ...
            <Card key={idx}>
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <span className="text-laputa-green text-xl">●</span>
                  <div>
                    <div className="text-body text-laputa-text-bright font-semibold">
                      {tool.name}
                    </div>
                    <div className="text-body-sm text-laputa-text-dim">
